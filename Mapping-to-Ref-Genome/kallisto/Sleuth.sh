...
pheno_file="/lustre/projects/Research_Project-191391/Morteza/kallisto/UKBBN.Phenotype.csv"
...
Rscript ${ScriptDir}/Sleuth.R $kallisto_res_dir $pheno_file $target_map_file $lm_model $factor_variables $numeric_variables $OutPrefix
